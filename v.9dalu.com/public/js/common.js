	...
	tuijianok:function(o,text,count,weibo_id,mid,fid,img){
		...
		$.post(U("weibo/Operate/tuijian"),{id55:weibo_id},function(res){
			if( res<1){
				...
				this.html = '<div id="ts_ui_tuijian" class="ts_confirm">你已经推荐过了,是否删除此推荐<br><input type="button" value="确定"  class="btn_b mr5"><input type="button" value="取消"  class="btn_w"></div>';
				$('body').append(this.html);
				var position = $(o).offset();
