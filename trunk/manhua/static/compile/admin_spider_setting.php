...
<div id="wrap">
	<div class="path">
		...
		<span>配置采集工具</span>
		<span><a href="admin.php?c=spiderCustom&a=list">定制采集列表</a></span>
	</div>
		...
		<div class="c1">
			<div class="tab_b"> 
				...
				<table width="100%" class="table1" border="0" cellpadding="0" cellspacing="1">
					<tr>
						<td>项目名称</td>
						<td style="text-align:left" colspan="2"><input type="text" name="spiderName" id="spiderName" value="" style="width:230px" />*</td>
					</tr> 
					<tr>
						<td>编码转换</td>
						<td style="text-align:left"><input type="checkbox" name="cutCode" id="cutCode" value="gb2312" />GBK转UTF8</td>
						<td></td>
					</tr> 
					<tr>
						<td width="14%">目标网址：</td> 
						...
						<br/>
						起始页：<input name="startPage" value="" style="width:40px" /> 结束页：<input name="endPage" value="" style="width:40px" /> 步长值：<input name="stepPage" value="1" style="width:40px" />
						</td>
					...
					<tr>
						<td>列表采集规则：</td>
						<td><textarea name="listRule" id="listRule" rows="7" cols="50"><li><a title='{*}' href="{url=*}" target="_blank">{title=*}</a></li></textarea></td>
					...
					<tr>
						...
						<td><textarea name="contentRule" id="contentRule" rows="7" cols="50"><td colspan="4" scope="col" class="thebc" id="tcc">{content=*}</td></textarea></td>
