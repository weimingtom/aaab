...
<div id="wrap">
	<div class="path">
		<span><a href="admin.php?c=getdata">数据管理</a></span>
	...
	<div class="content">
		<div class="c1">
			<div class="tab_b"> 
				<form action="admin.php?c=spider&a=execute" method="post"> 
				<table width="100%" class="table1" border="0" cellpadding="0" cellspacing="1">
					<tr>
						<td>编码转换</td>
						<td style="text-align:left"><input type="checkbox" name="cutCode" />GBK转UTF8</td>
						<td></td>
					</tr> 
					<tr>
						<td width="14%">目标网址：</td> 
						...
						<br/>
						起始页：<input name="startPage" value="" style="width:40px" /> 结束页：<input name="endPage" value="" style="width:40px" /> 步长值：<input name="step" value="1" style="width:40px" />
						</td>
					...
					<tr>
						...
						<td><textarea name="contentRule" id="contentRule" rows="7" cols="50"></textarea></td>
					...
					<tr>
						<td>&nbsp;</td>
						<td colspan="2" align="left"><input name="submit" type="submit" class="w02" value="提交" /></td>
					</tr>
				</table> 
				</form> 
			</div>
