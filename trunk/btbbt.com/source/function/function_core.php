...
function avatar($uid, $size = 'middle', $returnsrc = FALSE, $real = FALSE, $static = FALSE, $ucenterurl = '') {
	...
	if(!$staticavatar && !$static) {
		...
		$file = 'http://image.btbbt.com/uc_server/data/avatar/'.$dir1.'/'.$dir2.'/'.$dir3.'/'.substr($uid, -2).($real ? '_real' : '').'_avatar_'.$size.'.jpg';
		$ucenterurl = str_replace('www.btbbt.com', 'image.btbbt.com', $ucenterurl);
