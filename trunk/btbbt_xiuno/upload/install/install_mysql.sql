...
INSERT INTO bbs_forum SET fid='2', fup='1', name='默认版块一', rank='0', threads='0', posts='0', todayposts='0', lastpost='', lasttid='0', lastsubject='', lastuid='', lastusername='', brief='', rule='', icon='', status='1', listtype='0', orderby='0', indexforums='0', seo_title='', seo_keywords='';
INSERT INTO bbs_forum SET fid='3', fup='1', name='默认版块二', rank='0', threads='0', posts='0', todayposts='0', lastpost='', lasttid='0', lastsubject='', lastuid='', lastusername='', brief='', rule='', icon='', status='1', listtype='0', orderby='0', indexforums='0', seo_title='', seo_keywords='';
...
CREATE TABLE bbs_thread (
  ...
  KEY (typeid),						# 主题分类
  KEY (fid, floortime)					# 根据最后顶起来的时间戳排序
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
# 根据 pmid 分区，定长表？此表会很大！ 1000w 占用1G空间 1亿，占用10G！还凑合吧。 10,000,000,000
