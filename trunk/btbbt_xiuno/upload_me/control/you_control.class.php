...
class you_control extends common_control {
	...
	public function on_post() {
		...
		$pages = misc::simple_page("?you-post-uid-$uid.htm", count($mypostlist), $page, $pagesize);
	...
	public function on_follow() {
		...
		$pages = misc::simple_page("?you-follow-uid-$uid.htm", count($followlist), $page, $pagesize);
		$this->view->assign('pages', $pages);
	...
	public function on_followed() {
		...
		$pages = misc::simple_page("?you-follow-uid-$uid.htm", count($followedlist), $page, $pagesize);
		$this->view->assign('pages', $pages);
