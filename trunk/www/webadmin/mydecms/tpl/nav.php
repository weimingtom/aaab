...
<div class="nav">
  <ul>
    <li><a href="?action=add">添加导航菜单</a></li>
    <li><a href="?action=&page=1&typeid=5">显示</a></li>
    <li><a href="?action=&page=1&typeid=0">不显示</a></li>
  </ul>
  <div class="clear"></div>
</div>
  ...
  <table class="table" width="100%" border="0" cellpadding="0" cellspacing="1" align="center">
    <thead>
      <tr>
        ...
        <th width="200"><div align="center">菜单文字</div></th>
        <th><div align="center">地址</div></th>
        <th width="160"><div align="center">属性</div></th>
    ...
    <tr onmouseover="this.style.backgroundColor='#EEF6FB';" onmouseout="this.style.backgroundColor='';">
      ...
      <td><div align="center">
          <?php echo select("type[]",array('5'=>'显示','1'=>'不显示'),$row['type']); ?>
        </div></td>
      <td><div align="center">
