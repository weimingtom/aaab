...
<form action="?action=<?php echo $pageinfo['act'];?>&typeid=<?php echo $typeid;?>" method="post">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table2" align="center">
      <thead>
        <tr>
          <th colspan="2"><div align="center"><?php  echo $pageinfo['subtitle']; ?>导航菜单</div></th>
        </tr>
      </thead>
      <tr>
        <td width="130"><div align="right">菜单文字：</div></td>
      ...
      <tr>
        ...
        <td><?php echo select("type",array('5'=>'显示','1'=>'不显示'),$row['type']); ?></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2"><div align="center">
          <input type="submit" name="button" id="button" value="<?php  echo $pageinfo['subtitle']; ?>导航菜单" />
